...
/**
 * Created by d on 1/12/2017.
 */

public abstract class CusFooterAdapter<T>  extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public CusFooterAdapter(List<T> data, boolean withHeader, boolean withFooter) {
        this.data = data;
    ...
    public void setFooterVisiblity(boolean isVisible){
        mWithFooter = isVisible;
    }
