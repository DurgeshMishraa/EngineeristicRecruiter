...
public class Version
{
    ...
    private String unpublishmessages;
    ...
    public void setBatchtoyears (String batchtoyears)
    {
        this.batchtoyears = batchtoyears;
    }
    ...
    public String getUnpublishmessages ()
    {
        return unpublishmessages;
    }

    public void setUnpublishmessages (String unpublishmessages)
    {
    ...
    {
        return batchfromyears;
    }

    public void setBatchfromyears (String batchfromyears)
    {
        this.batchfromyears = batchfromyears;
    }
    ...
    public void setFilterlocations (String filterlocations)
    {
    ...
    public void setDobyears (String dobyears)
    {
    ...
    {
        return "ClassPojo [expectedsalaries = "+expectedsalaries+", batchtoyears = "+batchtoyears+", periodyears = "+periodyears+", companies = "+companies+", expyears = "+expyears+", coursetypes = "+coursetypes+", degrees = "+degrees+", unpublishmessages = "+unpublishmessages+", salaries = "+salaries+", institutes = "+institutes+", locations = "+locations+", noticeperiods = "+noticeperiods+", batchfromyears = "+batchfromyears+", filterlocations = "+filterlocations+", industries = "+industries+", functionalareas = "+functionalareas+", categories = "+categories+", dobyears = "+dobyears+"]";
    }
}
